...
<div class="container">	
	...
	<?php if(isset($_SESSION['username']) && $_SESSION['username'] == $_SESSION['username']) { ?>
        ...
        <?php } ?>
        <?php  if(isset($_SESSION['username']) && $_SESSION['username'] == $_SESSION['username']) { ?>
        <a href="AddAdmins/admin.php" style="font-weight: bold; font-size: 20px; display: flex;">Add Admins</a> 
        <?php } ?>
        <?php  if(isset($_SESSION['username']) && $_SESSION['username'] == $_SESSION['username']) { ?>
        <a href="AddAdmins/admin1.php" style="font-weight: bold; font-size: 20px; display: flex;">Add Users</a> 
        <?php } ?>

	<?php if(isset($_SESSION['username']) && $_SESSION['username']) { ?>
		<a href="logout.php" style="font-weight: bold; display: flex;">Logout</a>
